...
CSV_PATH = os.path.join(SCRIPT_DIR, "cleaned.csv")

# If cleaned.csv doesn't exist in this directory, try Data Wrangling directory
if not os.path.exists(CSV_PATH):
    CSV_PATH = os.path.join(os.path.dirname(SCRIPT_DIR), "Data Wrangling", "cleaned.csv")
...
plt.tight_layout()
kmeans_pca_path = os.path.join(SCRIPT_DIR, "kmeans_pca_clusters.png")
plt.savefig(kmeans_pca_path)
plt.close()
print(f"K-Means PCA plot saved to: {kmeans_pca_path}")
...
plt.ylabel("Count")
plt.tight_layout()
kmeans_dist_path = os.path.join(SCRIPT_DIR, "kmeans_distribution.png")
plt.savefig(kmeans_dist_path)
plt.close()
print(f"K-Means distribution plot saved to: {kmeans_dist_path}")
...
plt.legend(title="Cluster", loc="upper right")
plt.tight_layout()
hier_pca_path = os.path.join(SCRIPT_DIR, "hierarchical_pca_clusters.png")
plt.savefig(hier_pca_path)
plt.close()
print(f"Hierarchical PCA plot saved to: {hier_pca_path}")
...
plt.ylabel("Distance")
plt.tight_layout()
dendro_path = os.path.join(SCRIPT_DIR, "hierarchical_dendrogram.png")
